...
-- Create staff and staff schedule
SET @pw = md5("Password!");
SET @staff_type_id = 3;
SET @active = 1;
INSERT INTO user (email, first_name, last_name, password, user_type, status, phone) VALUES
("xavier@radin.com", "Xavier", "Radin", @pw, @staff_type_id, @active, "1231231234"),
("ruby@vanca.com", "Ruby", "Vanca", @pw, @staff_type_id, @active, "1231231234"),
("ted@yaniston.com", "Ted", "Yaniston", @pw, @staff_type_id, @active, "1231231234"),
("jessica@aroyu.com", "Jessica", "Aroyu", @pw, @staff_type_id, @active, "1231231234"),
("sarah@lim.com", "Sarah", "Lim", @pw, @staff_type_id, @active, "1231231234");
SET @xavier = (select id from user where email="xavier@radin.com");
SET @ruby = (select id from user where email="ruby@vanca.com");
SET @ted = (select id from user where email="ted@yaniston.com");
SET @jessica = (select id from user where email="jessica@aroyu.com");
SET @sarah = (select id from user where email="sarah@lim.com");
INSERT INTO staff_schedule (user_id, start_datetime, end_datetime) VALUES
-- Cook
(@xavier, '2022-12-07 06:00:00', '2022-12-07 16:00:00'),
(@xavier, '2022-12-08 06:00:00', '2022-12-08 16:00:00'),
(@xavier, '2022-12-09 06:00:00', '2022-12-09 16:00:00'),
(@xavier, '2022-12-10 06:00:00', '2022-12-10 16:00:00'),
(@xavier, '2022-12-11 06:00:00', '2022-12-11 16:00:00'),
(@xavier, '2022-12-12 06:00:00', '2022-12-12 16:00:00'),
(@xavier, '2022-12-13 06:00:00', '2022-12-13 16:00:00'),
(@xavier, '2022-12-15 06:00:00', '2022-12-15 16:00:00'),
(@xavier, '2022-12-16 06:00:00', '2022-12-16 16:00:00'),
(@xavier, '2022-12-17 06:00:00', '2022-12-17 16:00:00'),
(@xavier, '2022-12-21 06:00:00', '2022-12-21 16:00:00'),
(@xavier, '2022-12-22 06:00:00', '2022-12-22 16:00:00'),
(@xavier, '2022-12-23 06:00:00', '2022-12-23 16:00:00'),
-- Cook
(@ruby, '2022-12-07 10:30:00', '2022-12-07 21:00:00'),
(@ruby, '2022-12-08 10:30:00', '2022-12-08 21:00:00'),
(@ruby, '2022-12-09 10:30:00', '2022-12-09 23:00:00'), -- Fri
(@ruby, '2022-12-10 10:30:00', '2022-12-10 23:00:00'), -- Sat
(@ruby, '2022-12-13 10:30:00', '2022-12-13 21:00:00'),
(@ruby, '2022-12-15 10:30:00', '2022-12-15 21:00:00'),
(@ruby, '2022-12-16 10:30:00', '2022-12-16 23:00:00'), -- Fri
(@ruby, '2022-12-17 10:30:00', '2022-12-17 23:00:00'), -- Sat
(@ruby, '2022-12-21 10:30:00', '2022-12-21 21:00:00'),
(@ruby, '2022-12-22 10:30:00', '2022-12-22 21:00:00'),
-- Waiters/Waitresses
(@ted, '2022-12-07 06:00:00', '2022-12-07 16:00:00'),
(@ted, '2022-12-08 06:00:00', '2022-12-08 16:00:00'),
(@ted, '2022-12-09 06:00:00', '2022-12-09 16:00:00'),
(@ted, '2022-12-10 06:00:00', '2022-12-10 16:00:00'),
(@ted, '2022-12-11 06:00:00', '2022-12-11 16:00:00'),
(@ted, '2022-12-12 06:00:00', '2022-12-12 16:00:00'),
(@ted, '2022-12-13 06:00:00', '2022-12-13 16:00:00'),
(@ted, '2022-12-14 06:00:00', '2022-12-14 16:00:00'),
(@ted, '2022-12-16 06:00:00', '2022-12-16 16:00:00'),
(@ted, '2022-12-17 06:00:00', '2022-12-17 16:00:00'),
(@ted, '2022-12-21 06:00:00', '2022-12-21 16:00:00'),
(@ted, '2022-12-22 06:00:00', '2022-12-22 16:00:00'),
(@ted, '2022-12-23 06:00:00', '2022-12-23 16:00:00'),

(@jessica, '2022-12-07 10:30:00', '2022-12-07 21:00:00'),
(@jessica, '2022-12-08 10:30:00', '2022-12-08 21:00:00'),
(@jessica, '2022-12-09 10:30:00', '2022-12-09 23:00:00'), -- Fri
(@jessica, '2022-12-10 10:30:00', '2022-12-10 23:00:00'), -- Sat
(@jessica, '2022-12-13 10:30:00', '2022-12-13 21:00:00'),
(@jessica, '2022-12-15 10:30:00', '2022-12-15 21:00:00'),
(@jessica, '2022-12-16 10:30:00', '2022-12-16 23:00:00'), -- Fri
(@jessica, '2022-12-17 10:30:00', '2022-12-17 23:00:00'), -- Sat
(@jessica, '2022-12-18 07:00:00', '2022-12-18 16:30:00'), -- Sun
(@jessica, '2022-12-21 10:30:00', '2022-12-21 21:00:00'),
(@jessica, '2022-12-22 10:30:00', '2022-12-22 21:00:00'),

(@sarah, '2022-12-07 10:30:00', '2022-12-07 19:00:00'),
(@sarah, '2022-12-08 10:30:00', '2022-12-08 19:00:00'),
(@sarah, '2022-12-09 10:30:00', '2022-12-09 21:00:00'), -- Fri
(@sarah, '2022-12-10 10:30:00', '2022-12-10 21:00:00'), -- Sat
(@sarah, '2022-12-14 10:30:00', '2022-12-14 19:00:00'),
(@sarah, '2022-12-15 10:30:00', '2022-12-15 21:00:00'),
(@sarah, '2022-12-16 10:30:00', '2022-12-16 21:00:00'), -- Fri
(@sarah, '2022-12-17 10:30:00', '2022-12-17 21:00:00'), -- Sat
(@sarah, '2022-12-18 07:00:00', '2022-12-18 16:30:00'), -- Sun
(@sarah, '2022-12-19 10:30:00', '2022-12-19 19:00:00'),
(@sarah, '2022-12-20 10:30:00', '2022-12-20 19:00:00'),
(@sarah, '2022-12-23 10:30:00', '2022-12-23 19:00:00');
